...
function cargarReportes() {
    ...
    const url = `${API_REPORTES}?tipo=${encodeURIComponent(tipo)}&estado=${encodeURIComponent(estado)}&busqueda=${encodeURIComponent(busqueda)}`;
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            // fallback seguro si no viene "limite"
